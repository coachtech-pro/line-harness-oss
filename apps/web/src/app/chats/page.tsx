  ...
  const loadAllFriends = useCallback(async () => {
    try {
      ...
      if (friendRes.success) {
        setAllFriends(
          (friendRes.data as unknown as { items: FriendItem[] }).items,
        );
      }
    } catch {
      /* silent */
                ...
                <div className="mb-2 flex flex-wrap items-center gap-x-3 gap-y-2 text-xs text-gray-600">
                  <label className="inline-flex items-center gap-2 cursor-pointer select-none">
                    <input
                      ...
                      onChange={(e) =>
                        setShowLoadingIndicator(e.target.checked)
                      }
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setLoadingSeconds(Number.parseInt(e.target.value, 10))
                    }
